      ...
      <div className="flex flex-col p-4 bg-gray-50 rounded-lg border border-gray-100">
        ...
        <div className="flex items-end gap-3">
          ...
          {hasMediaNacional ? (
             ...
             <div className="flex flex-col text-sm font-medium mb-1 text-gray-400">
                <span className="text-[11px] font-normal leading-tight hidden sm:block">Média Nac.<br/>Indisponível</span>
             </div>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {course.hasSinaes !== false && course.enade && (
          <Card className="lg:col-span-2">
            <CardHeader>
              <CardTitle>Resultados Consolidados SINAES (Referência: {course.cpcDetails?.ano})</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className={course.hasSinaes === false ? 'lg:col-span-3' : ''}>
          <CardHeader>
